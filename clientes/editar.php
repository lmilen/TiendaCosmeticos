    ...
    <div class="tarjeta card o-hidden border-0 shadow-lg my-5">
        ...
        <div class="card-body checkout_details_area">
            <!-- Le envio tipo=1 porquee es el admin quien esta editando -->
                <form method="POST" action="../Control/validarEditar.php?tipo=2&id=<?php echo $id; ?>">
                    <div class="form-group">
                        <label for="login">&nbsp; Usuario - Correo electrónico <span>*</span></label>
                        <input type="text" class="form-control form-control-user"
                            placeholder="Ingrese su correo electrónico" name="login" id="login" value="<?php echo $usuario; ?>">
                    </div>
                    <div class="form-group">
                        <label for="pass">&nbsp; Contraseña <span>*</span></label>
                        <input type="password" class="form-control form-control-user"
                            placeholder="Ingrese su contraseña" name="pass" id="pass" value="<?php echo $password; ?>">
                    </div>
                    <div class="form-group">
                    ...
                    <div class="form-group">
                        ...
                        <input type="number" class="form-control form-control-user"
                            placeholder="Ingrese su número de identificación" name="cc" id="cc" value="<?php echo $identificacion; ?>">
                    </div>
                    <div class="form-group">
